...
void HowToPlay();
 ...
 #define numFood 65
 #define ghostNum 1
 #define numHomeGhosts 2
 #define numHomeGhostEyes numHomeGhosts*2
...
struct Entities homeghosts[numHomeGhosts] = { {50, 113, 90, 150}, {230, 113, 270, 150}    };
struct Entities homeghosteyesWhite[numHomeGhostEyes] = { {63, 128}, {80, 128}, {243, 128}, {260, 128}  };    //coords for eyes i like { {62, 128}, {78, 128}, {65, 130}, {81, 130} };
struct Entities homeghosteyesBlack[numHomeGhostEyes] = {{66, 130}, {83, 130},{246, 130}, {263, 130}};
struct Entities ghostLegs[numGhostLegs] = { {55, 149}, {70, 149}, {85, 149},   {235, 149}, {250, 149}, {265, 149}  };
